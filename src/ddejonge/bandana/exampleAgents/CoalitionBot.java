...
public class CoalitionBot extends ANACNegotiator {
    /**
    ...
    public static void main(String[] args) {
        ...
        CoalitionBot myPlayer = new CoalitionBot(args);
        myPlayer.run();
     ...
     * @param args
     */
    public CoalitionBot(String[] args) {
        super(args);
        botName = "CoalitionBot";
        ...
        while (System.currentTimeMillis() < negotiationDeadline) {
            ...
            while (hasMessage()) {
                ...
                if (receivedMessage.getPerformative().equals(DiplomacyNegoClient.ACCEPT)) {
                    ...
                    // add participants to coalition in first turn
                    if (isFirstRound) {
                        List<String> dealParticipants = receivedProposal.getParticipants();
...
//        List<BasicDeal> supportHoldAndMoveDealsToOffer = new ArrayList<>();
        ...
        this.getLogger().logln("" + this.botName + ": The alive coalition members are: " + Arrays.toString(aliveAllies.toArray()), false);
...
//        }
    ...
    private void addToCoalition(Power power) {
        if (!coalitionMembers.contains(power) && power != me) {
            this.getLogger().logln("" + this.botName + ": Adding the power: " + power.getName() + " to coalition", true);
